        <div class="container">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a id="tabBtnElevi" class="nav-link" href="panou_control_elevi">
                ...
                <li class="nav-item">
                    <a id="tabBtnProfesori" class="nav-link active" href="#">
                ...
                <li class="nav-item">
                    <a id="tabBtnTaxe" class="nav-link" href="panou_control_taxe">
                ...
                <li class="nav-item">
                    <a id="tabBtnRapoarte" class="nav-link" href="panou_control_rapoarte">
            ...
            <div id="profesori" class="card">
                <div class="container">
                    <form action="" method="POST">
                        <label for="clasa">Materie:</label>
                        <select id="cmbClasa" class="form-control" name="materie">
                        ...
                        <input id="txtNume" class="form-control" type="text" name="nume" required>

                        <br>

                        <label for="prenume">Prenume:</label>
                        <input id="txtPrenume" class="form-control" type="text" name="prenume" required>

                        <br>

                        <label for="adresa">Adresa:</label>
                        <input id="txtAdresa" class="form-control" type="text" name="adresa" required>

                        <br>

                        <label for="telefon">Telefon:</label>
                        <input id="txtTelefon" class="form-control" type="text" name="telefon" required>
                        ...
                        <input id="dataNasterii" class="form-control" type="date" name="dataNasterii" required>

                        <br>

                        <label for="dataInregistrarii">Data inregistrarii:</label>
                        <input id="dataInregistrarii" class="form-control" type="date" name="dataInregistrarii" required>
                        ...
                        <input type="submit" class="btn btn-success" value="Introdu datele">
                        <a href="tabel_profesori" class="btn btn-primary">Vizualizeaza toti profesorii</a>
                    </form>
                </div>
