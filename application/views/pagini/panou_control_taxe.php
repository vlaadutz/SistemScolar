<div class="container">
	<ul class="nav nav-tabs">
		...
		<li class="nav-item">
			<a id="tabBtnTaxe" class="nav-link active" href="#">
		...
		<script>
			$("document").ready(function () {
				$("#burse").highcharts({
					...
					"title": {
						"text": "Burse in sectoarele municipiului Bucuresti"
					},

					"series": [
						<?php foreach($burse as $bursa): ?>
							{
								"name": "<?php echo $bursa -> numeOras;?>",
								"data": [<?php echo $bursa -> bursa; ?>]
							},
						<?php endforeach; ?>
					]
				});
