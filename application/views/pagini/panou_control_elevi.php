        <div class="container">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a id="tabBtnElevi" class="nav-link active" href="#">
                ...
                <li class="nav-item">
                    <a id="tabBtnProfesori" class="nav-link" href="panou_control_profesori">
            ...
            <div id="elevi" class="card">
                <div class="container">
                    <form action="" method="POST">
                        ...
                        <a href="tabel_elevi" class="btn btn-primary">Vizualizeaza toti elevii</a>
                    </form>
                </div>
