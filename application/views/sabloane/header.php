...
<html lang="en">
    ...
    <body>
        <?php if (isset($nuAfisaBara) === false): ?>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="#">Sistem Scolar</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <?php if ($autentificat === false): ?>
                            <li class="nav-item active">
                                <a class="nav-link" href="<?php echo $url . "autentificare"; ?>">
                        ...
                        <?php if ($autentificat): ?>
                            <li class="nav-item active">
                                <a class="nav-link" href="<?php echo $url . "panou_control_elevi"; ?>">
